      ...
      <div className="max-w-4xl mx-auto px-6 text-center"
        ...
        <div className="bg-gradient-to-br from-[#1B3A2D] to-[#0F2419] rounded-3xl p-12 text-white relative overflow-hidden">
          ...
          <div className="relative z-10">
            <span className="text-[#6BBD45] text-sm font-semibold tracking-widest uppercase">{t.cta.eyebrow}</span>
            <h2 className="text-3xl md:text-4xl font-bold mt-3 mb-4">{t.cta.headline}</h2>
