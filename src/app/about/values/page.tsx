      ...
      <div className="py-12 px-6 lg:px-10 xl:px-14 bg-white">
        <div className="grid sm:grid-cols-2 xl:grid-cols-3 gap-5 mb-10">
          {values.map(v => (
            <div key={v.title} className="group bg-white border border-gray-100 hover:border-[#6BBD45]/40 rounded-2xl p-6 hover:shadow-md transition-all duration-300">
              ...
              <p className="text-gray-500 leading-relaxed" className="text-base">{v.desc}</p>
            </div>
          ))}
        </div>
        ...
        <div className="bg-[#6BBD45]/10 border border-[#6BBD45]/30 rounded-2xl p-8">
          <div className="flex items-start gap-5">
            ...
            <div>
              <h3 className="font-black text-[#1B3A2D] mb-2" className="text-base">Responsible Business Alliance (RBA)</h3>
              <p className="text-gray-600 leading-relaxed" className="text-base">Cofreth is fully committed and complies with the Responsible Business Alliance as part of our code of business conduct — ensuring ethical practices across our entire supply chain and operations, from procurement to project completion.</p>
            </div>
          </div>
        </div>
      </div>
